...
namespace TakeALook.Repository.Mapping
{
    ...
    /// </summary>
    public class PoiMap : EntityTypeConfiguration<Poi>, ITakeALookDBContextObject
    {
        public PoiMap()
        {
            HasKey(t => t.ID);
            ...
            Property(t => t.ProvinceID).IsRequired();
            Property(t => t.DistrictID).IsRequired();
            Property(t => t.NeighborhoodID).IsRequired();
            Property(t => t.TableName).IsRequired().HasMaxLength(300);
            Property(t => t.CustomID).IsRequired().HasMaxLength(300);
